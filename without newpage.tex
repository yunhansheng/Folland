...
From here prove
\[\lim\sup_k\int f_k\,d\mu\leq\int f\,d\mu\leq\lim\inf_k\int f_k\,d\mu\]
...
\begin{claim}
Let $(\Omega,\mathscr{F},\mu)$ be measure space, $f$ be non-negative and $\mathscr{F}$-measurable, and $\mu_f$ the measure defined by $\mu_f(A)=\int_Af\,d\mu$, then a collection $\mathscr{C}$ of integrable functions is \textbf{uniformly integrable}, i.e.
