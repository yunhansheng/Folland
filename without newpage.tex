...
\addcontentsline{toc}{section}{\protect\numberline{}\S1. Classes of subsets (semi-álgebras, álgebras and $\sigma$-álgebras)}
...
\addcontentsline{toc}{section}{\protect\numberline{}\S8. Integration: measurable and simple functions}

\begin{defin}
Let measure space $(\Omega,\mathscr{F},\mu)$, $\mathscr{B}$ the Borel $\sigma$-álgebra, and \[\overline{\mathscr{B}}=\{A\cup B:A\in\mathscr{B},B\subset\{\pm\infty\}\}\]
...
\addcontentsline{toc}{section}{\protect\numberline{}\S9. Measurable functions}
