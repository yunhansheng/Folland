...
Hence we can use Carathéodory's Theorem to extend $\mu$ defined above \emph{uniquely} on $\mathscr{F}_1\ast\mathscr{F}_2$, which will be called the \textbf{product measure}.
